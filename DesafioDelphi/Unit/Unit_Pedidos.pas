...
type
  TForm_Pedidos = class(TForm)
    ...
    procedure AC_F7Execute(Sender: TObject);
    procedure AC_F6Execute(Sender: TObject);
  private
...
//******************************************************************************
procedure TForm_Pedidos.AC_F8Execute(Sender: TObject);
begin
btnNovoPrin.Click;
end;

//******************************************************************************
procedure TForm_Pedidos.AC_F7Execute(Sender: TObject);
begin
btnEditarPrin.Click;
end;

//******************************************************************************
procedure TForm_Pedidos.AC_F6Execute(Sender: TObject);
begin
btnExcluirPrin.Click;
end;
end.
