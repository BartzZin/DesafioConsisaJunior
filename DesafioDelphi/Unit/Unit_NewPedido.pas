...
begin
     MessageBox(Handle, 'Verifique se todos os campos obrigatórios foram preenchidos corretamente!', 'Pedido de Venda', MB_OK);
end
else
begin
...
begin
     ...
     begin
          MessageBox(Handle, 'Grave o lançamento os itens para finalizar o pedido!', 'Desafio Delphi', MB_OK);
     end;
end;
end;
...
begin
     ...
     begin
       ...
       begin
          //Aqui ele retorna true se um dos campos estiver vazio, Apresenta mensagem se True se não deixa prosseguir.
         lvValidacao := True;
       end;
     end;
